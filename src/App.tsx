        ...
        <div className="App-viewports">
          ...
          <div>
            ...
            <p className="App-desc">
              This is an exploration of delay and rollback-based netcode in a simulated network environment. For more details, please see the <a href="https://github.com/toolness/netcode-fun" target="_blank" rel="noopener noreferrer">GitHub README</a>.
            </p>
          </div>
          <div>
            <h2>Player 2</h2>
